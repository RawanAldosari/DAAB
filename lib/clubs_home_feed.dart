...
class ClubHomeFeed extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<FeedViewModel>(
        create: (_) => FeedViewModel(),
        child: Container(height: 1200, width: 450, child: c_feed()));
  }
}

class c_feed extends StatefulWidget {
  @override
...
class cHomeFeed extends State<c_feed> with SingleTickerProviderStateMixin {
  ...
  Widget buildItemsCards(
    ...
    if (document['clubID'].toString() == id) {
