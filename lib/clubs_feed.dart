...
class clubsFeed extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<FeedViewModel>(
        create: (_) => FeedViewModel(),
        child: Container(height: 1200, width: 450, child: clubs_feed()));
  }
}

class clubs_feed extends StatefulWidget {
  const clubs_feed({
    Key? key,
  }) : super(key: key);
...
class cFeed extends State<clubs_feed> {
  @override
  void initState() {
    super.initState();
    Future.delayed(
